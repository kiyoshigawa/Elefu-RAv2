...
//EELEFU: Updated to include the RA Board pinouts
#if MOTHERBOARD == 21
...
#define X_MIN_PIN			48
#define X_MAX_PIN			-1 //47

#define Y_STEP_PIN         58
#define Y_DIR_PIN          59
#define Y_ENABLE_PIN       57
#define Y_MIN_PIN          46
#define Y_MAX_PIN          -1 //45

#define Z_STEP_PIN         61
#define Z_DIR_PIN          62
#define Z_ENABLE_PIN       60
#define Z_MIN_PIN          44
#define Z_MAX_PIN          -1 //43
...
#define SDPOWER            -1
#define LED_PIN            13 //5V PWM

#define FAN_PIN            -1 //use extra +12V connectors for fan power

#define PS_ON_PIN          -1//Not used

#define HEATER_0_PIN       11	//12V PWM1
#define HEATER_1_PIN       10	//12V PWM2 //10
#define HEATER_2_PIN       9	//12V PWM3 //9
#define HEATER_BED_PIN     12	//DOUBLE 12V PWM
...
#define PHOTOGRAPH_PIN     67

#ifdef RAPANEL

#define SDSS               53
//These are not used with the TWI LCD Backpack we have implemented, but still need to be here to compile properly for now.
#define LCD_PINS_RS 22 
#define LCD_PINS_ENABLE 23
#define LCD_PINS_D4 24
...
#define BTN_EN1 40
#define BTN_EN2 37
#define BTN_ENC 41  //the click
    
#define BLEN_C 2
#define BLEN_B 1
#define BLEN_A 0
    
#define SDCARDDETECT 36
